...
test_split <- str_split(test, '\\n')[[1]]
 str_match(test_split[39], paste0("(", time_pattern, ")", "\\D*", "(", time_pattern, ")", "\\W*", "(", call_pattern, ")", "\\W*"))
```
...
```{r}
test_df <- build_data_frame("July 27, 1969", diary.1969$`July 27, 1969`$pages, debug = TRUE)
```
